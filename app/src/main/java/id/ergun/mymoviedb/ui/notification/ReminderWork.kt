...
class ReminderWork(context: Context, params: WorkerParameters) : Worker(context, params) {
    ...
    private fun sendNotification(id: Int) {
        ...
        val titleNotification = applicationContext.getString(R.string.message_add_to_favorite)
        val subtitleNotification = applicationContext.getString(R.string.message_data_not_found)
